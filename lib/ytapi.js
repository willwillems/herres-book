...
export const getPlaylistItems = (key) => (playlistID) => fetch(`https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=${playlistID}&maxResults=50&key=${key}`).then(r => r.json())
